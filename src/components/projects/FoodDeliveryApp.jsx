...
const FoodDeliveryApp = () => {
  ...
  return (
    ...
    >
      {/* Project Image */}
      <div className="relative w-full h-64 bg-gradient-to-br from-orange-500/20 to-red-500/20 rounded-lg mb-6 overflow-hidden group">
        ...
        <div className="absolute inset-0 bg-dark/0 group-hover:bg-dark/70 transition-all duration-300 flex items-center justify-center">
          <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex gap-4">
            ...
            <a
              href="https://github.com/yourusername/food-delivery-app"
              target="_blank"
              rel="noopener noreferrer"
      ...
      <p className="text-lightGray mb-4 leading-relaxed">
        A comprehensive food delivery platform connecting hungry customers with
        local restaurants. Features include real-time order tracking, secure
        payments, and an intuitive user interface for seamless food ordering
        experience.
      </p>
