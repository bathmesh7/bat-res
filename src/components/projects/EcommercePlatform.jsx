...
const EcommercePlatform = () => {
  ...
  return (
    ...
    >
      {/* Project Image */}
      <div className="relative w-full h-64 bg-gradient-to-br from-blue-500/20 to-purple-500/20 rounded-lg mb-6 overflow-hidden group">
      ...
      <p className="text-lightGray mb-4 leading-relaxed">
        ...
        Includes product management, secure payment processing, order tracking,
        and an admin panel for managing the entire e-commerce ecosystem.
      </p>
